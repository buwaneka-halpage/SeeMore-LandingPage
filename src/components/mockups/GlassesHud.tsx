  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/8 bg-[#12151c] p-5 sm:p-6">
      <div className="mb-4 flex items-center justify-between">
        <p className="font-mono text-[10px] tracking-[0.22em] text-teal uppercase">
          Aria-class optics
        </p>
        <span className="font-mono text-[10px] text-amber">REC · 4K POV</span>
      </div>
      ...
      <div className="relative mx-auto aspect-[16/10] max-w-md">
        <svg viewBox="0 0 420 240" className="h-full w-full" aria-hidden="true">
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <rect x="28" y="58" width="150" height="96" rx="28" fill="#0b0d11" stroke="#8a93a6" strokeWidth="3" />
          <rect x="242" y="58" width="150" height="96" rx="28" fill="#0b0d11" stroke="#8a93a6" strokeWidth="3" />
          <path d="M178 100c10-16 54-16 64 0" stroke="#8a93a6" strokeWidth="3" fill="none" />
          ...
          <g clipPath="url(#leftLens)" opacity="0.9">
            ...
            <rect x="52" y="118" width="86" height="18" rx="4" fill="#0B0D11" opacity="0.72" />
            <text x="58" y="131" fill="#2DD4C8" fontSize="10" fontFamily="ui-monospace, monospace">
              DE → EN live
            </text>
          </g>
          ...
          <g clipPath="url(#rightLens)" opacity="0.9">
            ...
            <text x="270" y="140" fill="#E8A54B" fontSize="9" fontFamily="ui-monospace, monospace">
              SIGIRIYA · L3
            </text>
          </g>
        </svg>
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
        {[
          ...
          <div key={k} className="rounded-lg border border-white/6 bg-black/30 px-2 py-2">
            <p className="font-mono text-[9px] tracking-widest text-muted-foreground">{k}</p>
            <p className="mt-0.5 font-mono text-xs text-foreground">{v}</p>
          </div>
        ))}
      </div>
    </div>
