  ...
  return (
    ...
    >
      ...
      <div className="rounded-xl border border-teal/20 bg-teal/5 p-4">
        <p className="font-mono text-[10px] tracking-widest text-teal/80 uppercase">
          Monthly profit
        </p>
        ...
        <p className="mt-1 text-xs text-muted-foreground">86-glass DMC fleet · HaaS lease paid</p>
      </div>
      ...
      <div className="mt-4 space-y-2">
        {guides.map((guide) => (
          ...
          >
            <div>
              <p className="text-sm text-foreground">{guide.name}</p>
              <p className="font-mono text-[10px] text-muted-foreground">
                {guide.lang} · {guide.status}
              </p>
            </div>
            <span className="font-mono text-[10px] text-teal">{guide.ping}</span>
          </div>
        ))}
      </div>
    </div>
